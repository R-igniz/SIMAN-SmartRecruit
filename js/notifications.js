...
function agregarNotificacion(tipo, mensaje, link, icono) {
    try {
        ...
        console.warn('Error al agregar notificación:', e);
    }
}
...
function mostrarNotificacionToast(notificacion) {
    try {
        ...
        toast.style.cssText = `
            ...
            color: ${document.body.classList.contains('dark-mode') ? '#e2e8f0' : '#404040'};
        ...
        toast.innerHTML = `
            ...
            <div style="flex:1; min-width:0;">
                ...
                <div style="font-size:11px; color:#5f6b7a;">${new Date(notificacion.fecha).toLocaleTimeString()}</div>
            </div>
            <button onclick="this.parentElement.remove()" style="background:none; border:none; color:#5f6b7a; cursor:pointer; font-size:16px; flex-shrink:0;">×</button>
        `;
        ...
        console.warn('Error mostrando toast:', e);
    }
}
